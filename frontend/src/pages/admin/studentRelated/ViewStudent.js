...
const ViewStudent = () => {
    ...
    const chartData = [
        ...
        { name: 'Faltou', value: overallAbsentPercentage }
    ];
        ...
        const renderTableSection = () => {
            return (
                <>
                    ...
                    <Table>
                        <TableHead>
                            <StyledTableRow>
                                ...
                                <StyledTableCell>Porcentagem de presença</StyledTableCell>
                    ...
                    <Button variant="contained" color="error" startIcon={<DeleteIcon />} onClick={() => removeHandler(studentID, "RemoveStudentAtten")}>Deletar</Button>
